...
public class TextMessages {
    public final static String DELETE_MESSAGE = "Введите имя файла (вместе с расширением), который хотите удалить";
    ...
    public final static String RENAME_FILE = "Введите старое имя файла (вместе с расширением), затем новое";
