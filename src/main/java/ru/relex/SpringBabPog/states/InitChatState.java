...
public final class InitChatState extends ChatState {
    ...
    public ChatMessageHandlingResult acceptMessage(ChatMessage message) {
        return switch (message.getText()) {
            case "save", "SAVE" -> new ChatMessageHandlingResult(TextMessages.EXEC_SAVE, new WaitForDocumentState());
            ...
            case  "md", "mkdir", "MD", "MKDIR"-> new ChatMessageHandlingResult(TextMessages.EXEC_MKDIR, new InitChatState());
